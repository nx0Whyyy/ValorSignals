...
**Version 2.1.7** — Dynamic celestial events for the ValorSky Minecraft network, targeting **Folia 1.21.11**.
...
Version 2.1.7 uses the supplied flying meteor, an 8-second configurable descent with an animated flame, smoke and lava aura, then reconstructs the complete 46-element impact scene at the announced coordinates. The client pack remains the automatically distributed 2.1.6 pack.
