...
**Version 2.1.1** — Dynamic celestial events for the ValorSky Minecraft network, targeting **Folia 1.21.11**.
...
Version 2.1.1 includes the supplied meteor model as a separate Minecraft 1.21.11 resource pack. Build everything with `./gradlew build dist`; the client pack is written to `build/distributions/ValorSky-SkySignals-ResourcePack-2.1.1.zip`.
