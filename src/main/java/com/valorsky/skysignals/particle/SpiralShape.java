...
public class SpiralShape implements ParticleShape {
    ...
    public SpiralShape(double startRadius, double endRadius, double height) {
        this(startRadius, endRadius, height, 3, 16);
    }

    public SpiralShape(double startRadius, double endRadius, double height, int turns, int pointsPerTurn) {
